...
// 
// Solution: Qorpent
// Original file : BugFixingThemaTest.cs
...
namespace Qorpent.Themas.Compiler.Tests {
	public class BugFixingThemaTest : ThemaCompilerTestBase {
		protected override ThemaProject getDefaultProject() {
			...
			result.UseEcoOptimization = false;
			result.OutputFolder = "~/bugfixout";
			result.SourceFiles = new List<string> {"~/bugfix/" + GetType().Name + ".bxl"};
			return result;
		}
	}
}